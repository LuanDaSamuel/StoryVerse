...
export const FolderIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
        ...
        <path fillRule="evenodd" d="M12.97 3.97a.75.75 0 011.06 0l2.25 2.25a.75.75 0 010 1.06l-2.25 2.25a.75.75 0 01-1.06-1.06l1.72-1.72-1.72-1.72a.75.75 0 010-1.06z" clipRule="evenodd" />
    </svg>
);

export const LightbulbIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
        <path d="M12 2.25a.75.75 0 01.75.75v.549c.532.125 1.037.345 1.5.641l.328-.42a.75.75 0 011.168.924l-.328.42c.43.34.814.733 1.144 1.164l.42-.328a.75.75 0 01.924 1.168l-.42.328c.296.463.516.968.641 1.5h.549a.75.75 0 010 1.5h-.549c-.125.532-.345 1.037-.641 1.5l.42.328a.75.75 0 01-.924 1.168l-.42-.328a4.509 4.509 0 01-1.144 1.144l.328.42a.75.75 0 01-1.168.924l-.328-.42a4.509 4.509 0 01-1.5.641v.549a.75.75 0 01-1.5 0v-.549c-.532-.125-1.037-.345-1.5-.641l-.328.42a.75.75 0 01-1.168-.924l.328-.42a4.509 4.509 0 01-1.144-1.144l-.42.328a.75.75 0 01-.924-1.168l.42-.328a4.509 4.509 0 01-.641-1.5h-.549a.75.75 0 010-1.5h.549c.125-.532.345-1.037.641-1.5l-.42-.328a.75.75 0 01.924-1.168l.42.328c.34-.43.733-.814 1.164-1.144l-.328-.42a.75.75 0 01.924-1.168l.328.42c.463-.296.968-.516 1.5-.641V3a.75.75 0 01.75-.75zM12 6a3.75 3.75 0 100 7.5 3.75 3.75 0 000-7.5zM10.875 15a.75.75 0 00-1.125 1.125 3.375 3.375 0 006.5 0 .75.75 0 00-1.125-1.125H10.875z" />
    </svg>
);
...
export const DownloadIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
        ...
        <path d="M3.75 13.5a.75.75 0 00-1.5 0v6a3 3 0 003 3h12a3 3 0 003-3v-6a.75.75 0 00-1.5 0v6a1.5 1.5 0 01-1.5 1.5h-12a1.5 1.5 0 01-1.5-1.5v-6z" />
    </svg>
);
...
export const UploadIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
        <path fillRule="evenodd" d="M12 2.25a.75.75 0 01.75.75v11.69l3.22-3.22a.75.75 0 111.06 1.06l-4.5 4.5a.75.75 0 01-1.06 0l-4.5-4.5a.75.75 0 111.06-1.06l3.22 3.22V3a.75.75 0 01.75-.75z" clipRule="evenodd" transform="rotate(180 12 12)" />
        <path d="M3.75 13.5a.75.75 0 00-1.5 0v6a3 3 0 003 3h12a3 3 0 003-3v-6a.75.75 0 00-1.5 0v6a1.5 1.5 0 01-1.5 1.5h-12a1.5 1.5 0 01-1.5-1.5v-6z" />
    </svg>
);
...
export const RedoIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
        <path fillRule="evenodd" d="M14.47 2.47a.75.75 0 011.06 0l6 6a.75.75 0 010 1.06l-6 6a.75.75 0 11-1.06-1.06L19.19 8.25H9a6.75 6.75 0 000 13.5h3a.75.75 0 010 1.5H9a8.25 8.25 0 010-16.5h10.19l-4.72-4.72a.75.75 0 010-1.06z" clipRule="evenodd" />
    </svg>
);
