...
export const SettingsIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
        <path fillRule="evenodd" d="M9 2 H15 V9 H22 V15 H15 V22 H9 V15 H2 V9 H9 V2 Z M16 12 A4 4 0 1 1 8 12 A4 4 0 1 1 16 12 Z" />
    </svg>
);
...
export const AppLogoIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
        <path fillRule="evenodd" d="M7 2a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2H7zM8 6h8v2H8V6zm0 5h8v1H8v-1zm0 3h6v1H8v-1z" />
    </svg>
);

export const DocumentPlusIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 0 0-3.375-3.375h-1.5A1.125 1.125 0 0 1 13.5 7.125v-1.5a3.375 3.375 0 0 0-3.375-3.375H8.25m.75 12h6M12 15.75V9.75M4.5 9.75h.008v.008H4.5v-.008Zm0 3h.008v.008H4.5v-.008Zm0 3h.008v.008H4.5v-.008Z" />
    </svg>
);
...
export const TextIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M7.5 3v18M16.5 3v18M3 9h9m1.5 0h6M3 15h9m1.5 0h6" />
    </svg>
);
...
export const BoldIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M8 5h4.5a2.5 2.5 0 0 1 0 5H8m0-5v5m0 0h5a2.5 2.5 0 0 1 0 5H8V5z" />
    </svg>
);

export const ItalicIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M7 20 17 4M7 4h5M12 20h5" />
    </svg>
);
...
export const BlockquoteIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 5.25v13.5" strokeWidth="2.5"/>
    </svg>
);
...
export const OrderedListIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 7.5L3 6v0a1.5 1.5 0 011.5-1.5h0" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M3 12h1.5a.75.75 0 01.75.75V15" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 18H3a.75.75 0 01-.75-.75V15m1.5 3a.75.75 0 00-.75-.75H3" />
    </svg>
);

export const H1Icon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
    <text x="3" y="19" fontSize="14" fontWeight="bold" fontFamily="sans-serif">H1</text>
  </svg>
);

export const H2Icon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
    <text x="3" y="19" fontSize="14" fontWeight="bold" fontFamily="sans-serif">H2</text>
  </svg>
);

export const H3Icon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
    <text x="3" y="19" fontSize="14" fontWeight="bold" fontFamily="sans-serif">H3</text>
  </svg>
);
