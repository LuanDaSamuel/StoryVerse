...
export const translations = {
  en: {
    ...
    chapters: 'Chapters',
    chapter: 'Chapter',
    importFromDocx: 'Import from PDF',
    ...
    importDocxMessage: 'This will replace all existing chapters in this novel with the content from the selected PDF file(s). This action cannot be undone.',
    noCover: 'No Cover',
    ...
    // Added missing closeProjectTitle for English
  ...
  vi: {
    ...
    importDocxMessage: 'Thao tác này sẽ thay thế tất cả các chương hiện có trong tiểu thuyết này bằng nội dung từ (các) tệp PDF đã chọn. Hành động này không thể hoàn tác.',
    ...
    chapters: 'Luvut',
    chapter: 'Luku',
    importFromDocx: 'Tuo PDF-tiedostosta',
    ...
    importDocxMessage: 'Tämä korvaa kaikki tämän romaanin olemassa olevat luvut valitun PDF-tiedoston (tai tiedostojen) sisällöllä. Toimintoa ei voi kumota.',
    noCover: 'Ei kantta',
