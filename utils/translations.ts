...
export const translations = {
  ...
  vi: {
    ...
    copyChapterText: 'Sao chép văn bản',
    copied: 'Đã sao chép!',
  ...
  sv: {
    ...
    // Spell Check
    addToLibrary: 'Lägg till i ordlista',
    ignore: 'Ignorera',
    ...
    target: 'Mål',
    setDailyGoal: 'Ange dagligt ordmål',
    ...
    uploadCover: 'Ladda upp ett omslag',
    ...
    details: 'Detaljer',
    history: 'Historik',
    deleteNovelTitle: (title: string) => `Ta bort "${title}"?`,
    deleteNovelMessage: 'Är du säker? Detta kommer att permanent radera hela romanen och alla dess kapitel. Denna åtgärd kan inte ångras.',
    deleteChapterTitle: (title: string) => `Ta bort kapitel "${title}"?`,
    deleteChapterMessage: 'Är du säker på att du vill ta bort detta kapitel? Detta kan inte ångras.',
    ...
    editorTools: 'REDIGERINGSVERKTYG',
    ...
    spellCheckComplete: 'Kontroll klar',
    noErrorsFound: 'Inga fel hittades.',
    
    // Idea Box (Demos) Page
    newIdea: 'Ny idé',
    emptyIdeaBox: 'Din idélåda är tom.',
    emptyIdeaBoxHint: 'Klicka på "Ny idé" för att fånga ditt första berättelsekoncept, eller importera en idé från en DOCX-fil.',
    goToHomePage: 'Gå till hemsidan',
    noSynopsis: 'Ingen sammanfattning än.',
    deleteIdeaTitle: (title: string) => `Ta bort idé: ${title}`,
    ...
    title: 'TITEL',
    synopsisPreview: 'SAMMANFATTNING FÖRHANDSVISNING',
    proceed: 'Vill du fortsätta?',
    deleteIdeaConfirmTitle: (title: string) => `Ta bort "${title}"?`,
    deleteIdeaMessage: 'Är du säker på att du vill ta bort denna berättelseidé? Denna åtgärd är permanent och kan inte ångras.',
    folders: 'Mappar',
    newFolder: 'Ny mapp',
    ...
    deleteFolderConfirm: 'Ta bort denna mapp? Idéer inuti kommer att flyttas till roten.',
    ...
    deleteSketchTitle: (title: string) => `Ta bort skiss "${title}"?`,
    deleteSketchMessage: 'Är du säker på att du vill ta bort denna skiss? Denna åtgärd är permanent och kan inte ångras.',
    ...
    exportNovelMessage: (title: string) => `Välj ett format för att ladda ner "${title}" som en enda fil.`,
    exportScope: 'Exportomfattning',
    ...
    exportHtmlDesc: 'Bäst för kvalitet och stabilitet. Bevarar all formatering. Kan öppnas i valfri webbläsare och skrivas ut till en högkvalitativ PDF.',
    exportTxtTitle: 'Vanlig text (.txt)',
    exportTxtDesc: 'Bäst för kompatibilitet. Förlorar formatering som fetstil och kursiv stil.',
    exportMdTitle: 'Markdown (.md)',
    exportMdDesc: 'Bevarar fetstil och kursiv formatering. Bra för webbplattformar.',

    // Settings Modal
    language: 'Språk',
    theme: 'Tema',
    readingFontSize: 'Läsfontstorlek',
    projectManagement: 'Projekthantering',
    projectName: 'Projektnamn',
    storageLocation: 'Lagringsplats',
    storageLocationText: (location: string) => `Ditt projekt sparas i ${location}.`,
    ...
    signOutMessage: "Är du säker på att du vill logga ut? Ditt projekt sparas på Google Drive. Du kan logga in igen för att komma åt det.",
    closeProjectTitle: 'Stäng projekt?',
    closeProjectMessage: "Är du säker på att du vill stänga detta projekt? Alla osparade ändringar kommer att sparas innan stängning. Du kan öppna det senare från dina filer.",

    // Whats New Modal
    whatsNewTitle: "Nyheter i StoryVerse",
    proTip: 'PROTIPS',
    proTipMessage: 'Du kan när som helst byta tillbaka till den klassiska vyn för enstaka kapitel i Inställningar.',
  },
};
